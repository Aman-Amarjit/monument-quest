...
const fallbackJwtSecret = 'monument_quest_super_secret_jwt_key_2026_prod_fallback';
const jwtSecret = (configuredJwtSecret && configuredJwtSecret.length >= 16) ? configuredJwtSecret : fallbackJwtSecret;
